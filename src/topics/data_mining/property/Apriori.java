...
public class Apriori {
    ...
    public static final int MinSup = 40;
...
class AprioriCalculation {
    ...
    String transaFile = "IrisData.txt"; //transaction file
    ...
    private void getConfig() {
      ...
      //      System.out.print("Enter new configuration filename (return for '" + configFile + "'): ");
        ...
        try {
            ...
            //number of items
            numItems = Integer.valueOf(data_in.readLine());

            //number of transactions
            numTransactions = Integer.valueOf(data_in.readLine());

            //minsup
            minSup = Double.valueOf(data_in.readLine());
